...
<div class="shares container">
    ...
    <div class="refer-a-subagent">
        <h2>Пригласить субагента</h2>
        Вы можете пригласить субагента отослав ему эту ссылку
        <Alert>https://google.com <Icon style="float: right; margin-top: -3px;" type="ios-copy" size="24"/></Alert>
    </div>
    </Content>
    ...
    <Content :style="{padding: '24px', minHeight: '280px', background: '#fff'}" v-if="subContent == '2-2'">
        <h2>Субагенты</h2>
        <h4>
            Проcмотр заявок на регистрацию от Субагентов...
        </h4>
...
import {mapState} from 'vuex';
    ...
    export default {
        ...
        computed: mapState(["submenuCollapsed"]),
        methods: {
