...
<div class="shares container">
    <Layout>
        <Sider hide-trigger collapsible  width="auto" v-model="submenuCollapsed" style="background: #fff">
                            <Menu :class="menuitemClasses" :collapsed-width="78" active-name="1-2" theme="light" width="auto">
    ...
    <!-- Покупка акций (1-2) -->
    <Content :style="{padding: '24px', minHeight: '280px', background: '#fff'}" v-if="subContent == '1-2'">
    <div class="shares-info">
        ...
        <Alert style="text-align: center"><span class="share-balance">32 500</span></Alert>
